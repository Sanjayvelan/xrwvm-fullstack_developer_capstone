...
def initiate():
    car_make_data = [
        ...
        {"name":"Audi", "description":"Great cars. American technology"},
    ...
    for data in car_model_data:
        CarModel.objects.create(name=data['name'], car_type=data['car_type'], year=data['year'], car_make=data['car_make'])
